...
gene_objsh = {}
distance = 100000
number_of_spacers = 20
pairsh = {}
blast_pairsh = {}
pair_sep = "-"
e_value_cutoff = 1e-10
aln_length_cutoff = 40
...
def read_gff(gff, genes_included, type="gff3", attr = "ID"):
    in_fh = open(gff,'r')
    gene_objsh = {}
    for line in in_fh:
...
def get_tandem_relations(seq_objsh, gene_relations, distance):
    tandem_relations = {}
...
gene_objsh = read_gff(gff, genes_included, gff_type, attr)

tandem_relations = get_tandem_relations(gene_objsh, gene_relations, distance)
